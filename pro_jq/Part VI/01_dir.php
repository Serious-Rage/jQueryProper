...
<body onload="setSlctDfault()">
 ...
 <?php require_once 'dirArrays.php';?>
<?php
...
for ($x = 3; $x <= count($array); $x++) {
  if (is_dir($array[$x]))
   // echo "<option value=\"".$array[$x]."/pro-jquery/Part I/\" >".$array[$x]."</option><br>";
...
$myRoot = getcwd();
$partB = "/".$rootdr."/";
$localSrvrRoot = "http://localhost:8888/pro-jquery/Part I/";
//echo "<br><br>";
//echo $myRoot;
//echo "<br><br>";
...
echo "</select>";  
  ...
  <script>
     ...
     var baseRoot = "http://localhost:8888/pro-jquery/Part I/";
